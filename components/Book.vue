<template>
    <div class="flex flex-1 flex-col lg:flex-row bg-white">
        <div class="flex-none w-full lg:relative lg:w-48">
            <img :src="book.book_image" alt="" class="lg:absolute inset-0 w-full h-full object-cover" />
        </div>
        <form class="flex-auto p-6 flex flex-col">
            ...
            <div class="flex-auto flex space-x-3">
                <button class="w-1/2 flex items-center justify-center rounded-md bg-purple-900 text-white" type="submit">Kup teraz</button>
                <button class="w-1/2 flex items-center justify-center rounded-md border border-gray-600" type="button">Napisz do sprzedawcy</button>
            </div>
